import type { AttendanceListParams, SelfAttendanceListParams } from './attendance.api'
...
export const attendanceKeys = {
  ...
  selfHistory: (params: SelfAttendanceListParams) => [...attendanceKeys.self(), 'history', params] as const,

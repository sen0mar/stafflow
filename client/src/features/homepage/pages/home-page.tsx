...
export const HomePage = () => (
  <main className="dot-grid min-h-screen overflow-hidden text-primary">
    ...
    <section className="mx-auto grid max-w-[1440px] items-center gap-10 px-5 pb-10 pt-8 sm:px-6 lg:grid-cols-[0.82fr_1.18fr] lg:px-8 lg:pb-8 lg:pt-10">
      <div>
        ...
        <h1 className="mt-7 max-w-4xl text-5xl font-semibold leading-[1.04] tracking-normal text-primary sm:text-6xl lg:text-7xl">

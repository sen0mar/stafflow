...
export const HeroSection = () => (
  <section className="mx-auto grid min-h-[calc(100vh-5rem)] max-w-[1440px] items-center gap-10 px-5 pb-8 pt-5 sm:px-6 lg:grid-cols-[0.82fr_1.18fr] lg:px-8 lg:pb-6 lg:pt-6 2xl:max-w-[1760px] 2xl:grid-cols-[0.72fr_1.28fr] 2xl:gap-16 2xl:px-10 min-[2200px]:!max-w-[2200px]">
    <div>

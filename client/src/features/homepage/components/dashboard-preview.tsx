      ...
      <div className="p-4 sm:p-5 2xl:p-6">
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="flex items-center gap-2 rounded-full border border-default bg-elevated px-2 py-1 shadow-soft">
            <Avatar
              size="sm"
              className="overflow-visible bg-brand-soft ring-2 ring-brand-soft"
            >
        ...
        <div className="mt-5 grid grid-cols-2 gap-3 xl:grid-cols-4">
          {metrics.map((metric) => (
            <div
              key={metric.label}
              className="rounded-2xl border border-default bg-elevated p-3 shadow-soft"
            >
              <LandingIconWell
                icon={metric.icon}
        ...
        <div className="mt-3 grid gap-3 xl:grid-cols-[1.25fr_0.75fr]">
          <div className="rounded-2xl border border-default bg-elevated p-4 shadow-soft">
            <div className="flex items-center justify-between">
              ...
              <span className="rounded-xl border border-default px-2 py-1 text-[11px] text-muted">
                Last 7 Days
              </span>
            </div>

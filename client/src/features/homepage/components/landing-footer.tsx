...
export const LandingFooter = () => (
  <footer className="border-t border-default bg-overlay backdrop-blur">
    <div className="mx-auto flex max-w-[1440px] flex-col gap-6 px-5 py-8 text-sm text-muted sm:px-6 md:flex-row md:items-center md:justify-between lg:px-8 2xl:max-w-[1760px] 2xl:px-10 min-[2200px]:!max-w-[2200px]">
      <LandingBrandMark />
